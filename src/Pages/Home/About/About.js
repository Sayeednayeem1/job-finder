...
const About = () => {
    ...
    return (
        <div className='max-w-[1440px] mx-auto' data-aos="fade-down" data-aos-easing="linear">
            <div className='mx-4 mt-12 md:mt-44 mb-48'>
                <div className='flex flex-col md:flex-row items-center'>
                    <div className='mr-0 md:mr-28'>
                        ...
                        <p className="mb-6">We provide AI-powered marketing-tech solutions. 360-degree solutions to simplify your business experience. Our solutions are purpose-driven, performance-oriented, and advised by respected industry experts. We stand out by launching the correct technology with proper communication integration.</p>
                        <p><span className='text-2xl text-pink-600'>&#10003;</span> Job Searching</p>
                        <p><span className='text-2xl text-pink-600'>&#10003;</span> IT Consultancy</p>
                        <p><span className='text-2xl text-pink-600'>&#10003;</span> Fresher Jobs</p>
                        <p><span className='text-2xl text-pink-600'>&#10003;</span> Experienced Jobs</p>
                    </div>
